  ...
  return (
    <div className="w-full h-[250vh]">
      <div className="w-full h-[17%]  flex justify-between items-center max-sm:w-auto max-sm:justify-center">
        {valueOfWidth == true ? "" : <img src={left} alt="" />}
        ...
        {valueOfWidth == true ? "" : <img src={right} alt="" />}
      </div>
      ...
      <div
        className="w-full h-[30%]  bg-cover flex justify-between max-sm:flex-col max-sm:items-center"
        style={{
