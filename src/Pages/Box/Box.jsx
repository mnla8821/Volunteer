const SlideBar = () => {
  return (
    <div className="h-[100vh] max-xl:h-[auto]">
      <div className="h-[120vh]  pt-8  ">
        <div
          className="h-[100%]  w-full  bg-cover bg-center flex justify-evenly items-center max-md:flex-col"
          style={{
            backgroundImage: "var(--rectangle)",
          }}
        >
